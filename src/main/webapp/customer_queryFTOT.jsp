...
<title>Filter by Departure Time </title>
</head>
<body>
	<%
		...
		try {
			...
			String edt = request.getParameter("etTime");
			String ldt = request.getParameter("ltTime");
			...
			String str = "Select flight.fid, flight.AL_ID, flight.Flight_Num, flight.Plane_ID, flight.Domestic, flight.Origin, flight.Dest, flight.Dep_Time, flight.Arr_Time, flight.Stops, flight.One_Way, tickets.Price from flight join tickets on flight.FID = tickets.fid WHERE flight.Dep_Time between '" + edt + "' AND '" + ldt + "'" ;
